...
HF_MODEL_NAME=/root/projects/svd_lora/opensource_models/Llama-2-7b-hf
...
eval_batch_size=2 # Change the batch_size according to your device memory

## change test to dev to implement dev set evaluation.
CONFIG_PATH="configs/${language}_${task}_test.json"
GATE_PATH="../checkpoints/Gates/${language}_${task}.pt" # You can also change this to your own trained gate path.
